...
export function Sidebar({
  ...
  const navItems = [
    ...
    },
    {
      id: "quiz",
      title: "Quiz",
      subtitle: activeQuizMode === "knowledge" ? "Мэдлэгээ сорих" : activeQuizMode === "grade" ? "Анги сонгох" : "Атласын асуулт",
      icon: Trophy,
      onClick: () => setQuizExpanded((value) => !value),
      active: !!activeQuizMode || currentView === "leaderboard",
                ...
                {isQuiz && !collapsed && quizExpanded && (
                  <div className="mt-2 grid gap-2">
                    <QuizMenuButton
                      ...
                      active={activeQuizMode === "knowledge"}
                      onClick={() => onOpenQuiz("knowledge")}
                    />
                    <QuizMenuButton
                      icon={<Trophy className="size-4" />}
                      label="Анги сонгох"
                      active={activeQuizMode === "grade"}
