...
export function QuizLeaderboardPage({
  ...
  return (
    <div
      className="relative flex h-full min-h-0 flex-col overflow-y-auto px-4 py-5 sm:px-6 lg:px-8"
      style={{
    ...
    >
      <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-5">
        <div
          className="rounded-xl px-5 py-5 backdrop-blur"
          style={{
            background: T.panel,
            border: `1px solid ${T.border}`,
            boxShadow: "0 18px 60px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.03)",
          }}
        >
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs" style={{ color: T.textSub }}>
                  Түүхийн шалгалтын шилдэг оноонууд
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{ background: "rgba(15,23,42,0.42)", border: `1px solid ${T.border}`, color: T.textSub }}
              >
