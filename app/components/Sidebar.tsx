    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between gap-2">
          <div>
            <p
              className="mb-1 text-[8px] uppercase tracking-[0.6em]"
              style={{ color: T.textMuted }}
            >
              Монгол Атлас
            </p>
            <h2
              ...
              style={{
                color: T.amber,
                textShadow: `0 0 30px ${T.amberGlow}, 0 0 60px ${T.amberGlow}`,
              }}
            >
              {year}
            </h2>
        ...
        <div className="mt-4 flex items-center gap-2">
          ...
          <div
            ...
            style={{ background: T.amberDim, opacity: 0.5 }}
          />
          <div className="h-px flex-1" style={{ background: T.border }} />
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col gap-1.5 overflow-y-auto px-3 pb-2">
        {features.length === 0 && (
          <div
            className="mt-4 rounded-lg px-4 py-8 text-center text-xs"
            style={{ border: `1px solid ${T.border}`, color: T.textMuted }}
          >
            Энэ онд нутаг дэвсгэр олдсонгүй
          </div>
              ...
              <div className="pl-3.5">
                ...
                <div className="mt-1.5 flex items-center gap-1.5">
                  <div
                    className="h-px flex-1"
                    style={{
                      background: selected ? `${T.amber}30` : T.border,
                    }}
                  />
                  <p
                    className="text-[8px] uppercase tracking-[0.2em]"
